...
def key_press_event_analysis(key_press_event_df, classifier_name, print_results=False):
    ...
    if classifier_name == "k-NN":
        ...
        # 1. Without activity_id, session_number, start_timestamps, key_ids and key_ids_occurrences, the best k value was 1 with 62% accuracy in a one shot test accuracy
        # 2. After adding the new properties: session_duration_ms, hour_sin, hour_cos, dow_sin, dow_cos, month_sin, month_cos, is_weekend, part_of_day, down_up_duration_ms_avg, down_down_duration_ms_avg, up_down_duration_ms_avg, total_unique_keys_used, total_keys_pressed and characters_per_second, and hot encodings was false, the best k = 1 with 88% accuracy, 0.0063 FAR, 0.12 FRR and 0.0625 EER with 1.0 threshold
        # 3.  after setting one hot encoding to true, the best k = 1 with 87% accuracy, 0.0068 FAR, 0.13 FRR and 0.0675 EER with 1.0 threshold
        ...
        # 1. After best_n_estimators=100, the accuracy is relatively constant at around 59.94%
        #   but best_n_estimators=201 showed the best accuracy of 62.57%
        # 2. After adding the new properties: session_duration_ms, hour_sin, hour_cos, dow_sin, dow_cos, month_sin, month_cos, is_weekend, part_of_day, down_up_duration_ms_avg, down_down_duration_ms_avg, up_down_duration_ms_avg, total_unique_keys_used, total_keys_pressed and characters_per_second, and hot encodings was false, the best best_n_estimators = 151 with 86% accuracy, 0.0073 FAR, 0.14 FRR and 0.0179 EER with 0.4903 threshold
        # 3.  after setting one hot encoding to true, the best best_n_estimators = 101 with 86% accuracy, 0.0072 FAR, 0.14 FRR and 0.0169 EER with 0.4818 threshold
        ...
        # 1. After 1 hour of executing, the best params are: svm__C: 1000, svm__gama: 0.1 and svm__kernel: rbf with 62% accuracy
        # 2. After adding the new properties: session_duration_ms, hour_sin, hour_cos, dow_sin, dow_cos, month_sin, month_cos, is_weekend, part_of_day, down_up_duration_ms_avg, down_down_duration_ms_avg, up_down_duration_ms_avg, total_unique_keys_used, total_keys_pressed and characters_per_second, and hot encodings was false, the best params are: svm__C: 100, svm__gama: 0.01 and svm__kernel: rbf with 87% accuracy, 0.0068 FAR, 0.13 FRR and 0.0402 EER with 19.60 threshold
        # 3.  after setting one hot encoding to true, the best params are: svm__C: 100, svm__gama: 0.01 and svm__kernel: rbf with 89% accuracy, 0.0057 FAR, 0.11 FRR and 0.0470 EER with 19.50 threshold
    else:
